...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border/60 bg-[oklch(0.98_0.012_88/0.92)] backdrop-blur-lg supports-[backdrop-filter]:bg-[oklch(0.98_0.012_88/0.85)]">
